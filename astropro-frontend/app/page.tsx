...
function ThemeAwareLayout() {
  ...
  return (
    <div
      className={`relative min-h-screen transition-colors duration-700 ease-in-out selection:bg-orange-500/30 ${isDark ? "bg-[#020617] text-white" : "bg-white text-slate-900"
        }`}
    >
      ...
      <div
        className={`fixed inset-0 -z-30 pointer-events-none opacity-[0.02] mix-blend-overlay ${isDark ? "invert-0" : "invert"
          }`}
      ...
      <div
        className={`fixed top-0 left-1/2 -translate-x-1/2 w-full h-[600px] blur-[140px] -z-20 pointer-events-none transition-all duration-1000 ${isDark ? "bg-orange-600/10 opacity-100" : "bg-orange-200/20 opacity-40"
          }`}
      />
